...
from utils.creators import AnchorTargetCreator, ProposalTargetCreator

from torch import nn
import torch as t
from utils.array_util import totensor, tonumpy, scalar
...
class FasterRCNNTrainer(nn.Module):
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        roi_loc = roi_cls_loc[t.arange(0, n_sample).long().cuda(), totensor(gt_roi_label).long()]
    ...
    def save(self, save_optimizer=False, save_path=None, **kwargs):
        ...
        if save_path is None:
            ...
            save_path = '../..checkpoints/fasterrcnn_pretrained-%s.pth' % timestr
