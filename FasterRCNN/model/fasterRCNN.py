...
from utils.array_util import totensor, tonumpy
from utils.bbox_util import loc2bbox
...
class FasterRCNN(nn.Module):
    ...
    """
    def __init__(self, loc_normalize_mean=(0., 0., 0., 0.), loc_normalize_std=(0.1, 0.1, 0.2, 0.2),
                 n_fg_class=20, ratios=None, anchor_scales=None):
